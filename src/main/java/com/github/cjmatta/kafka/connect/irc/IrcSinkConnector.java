...
public class IrcSinkConnector extends SinkConnector {
  private static Logger log = LoggerFactory.getLogger(IrcSinkConnector.class);
  private IrcSourceConnectorConfig config; // TODO: Name...
